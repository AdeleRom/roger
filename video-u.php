        ...
        <section class="under-record">
            <div class="container">
                <div class="for-title text-center">
                    <p class="big">1 урок онлайн-школы "Паззлы"</p>
                    <div class="min-title min">Знакомство и приветствие Эдуарда Мавлютова.  <br class="d-none d-xl-inline">  Как получить максимум пользы на курсе.</div>
                </div>
            </div>
        </section>
